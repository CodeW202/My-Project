//p5.js-style loading of MainChacter.json 

let MainChacter;

function preload() {
  MainChacter = loadJSON("MainChacter.json");
}
...
function draw() {
  ...
  fill(200, 100, 100);
  rect(MainChacter.XPos + MainChacter.XSize + MainChacter.WeaponOffsetX, MainChacter.YPos + MainChacter.WeaponOffsetY, MainChacter.WeaponSizeX, MainChacter.WeaponSizeY);
